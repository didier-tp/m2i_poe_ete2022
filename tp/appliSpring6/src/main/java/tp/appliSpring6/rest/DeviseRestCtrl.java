...
import tp.appliSpring6.dto.MessageGenerique;
import tp.appliSpring6.util_dto.DtoConverter;
...
public class DeviseRestCtrl {
	...
	public Currency getDeviseByName(@PathVariable("codeDevise") String codeDevise) {
	    ...
	    return DtoConverter.deviseToCurrency(devise);
	...
	public List<Currency> getDevisesByCriteria(){
	    return DtoConverter.deviseListToCurrencyList(
